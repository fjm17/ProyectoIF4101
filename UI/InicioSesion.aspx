<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InicioSesion.aspx.cs" Inherits="UI.PaginaInicio" %>
...
<body>
    <form id="form1" runat="server" style="background-color=orange;width=500px">
